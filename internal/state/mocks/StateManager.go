...
func (_m *StateManager) GetOutputs() (map[string]string, error) {
	ret := _m.Called()
...
// WriteOutputs provides a mock function with given fields: outputs
func (_m *StateManager) WriteOutputs(outputs map[string]string) error {
